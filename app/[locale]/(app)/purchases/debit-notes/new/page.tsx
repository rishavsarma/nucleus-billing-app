...
export default function NewDebitNotePage() {
  ...
  const vendorOptions = [
    ...(selectedVendor &&
    !vendorsResult?.data.some((v) => v.id === selectedVendor.id)
  ...
  const relatedBills = (billsResult?.data ?? []).filter(
    ...
    createDebitNote.mutate(
      {
        ...
        purchase_bill_id:
          values.purchase_bill_id && values.purchase_bill_id !== NO_BILL
            ? values.purchase_bill_id
            : null,
