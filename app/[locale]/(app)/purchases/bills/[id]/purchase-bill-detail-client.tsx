...
export function PurchaseBillDetailClient({ id }: { id: string }) {
  ...
  const steps: StepperStep[] = [
    ...
    {
      label: t("stepReceived"),
      done: isPaid,
      current: isReceivedOrBeyond && !isPaid,
    },
        ...
        <div>
          ...
          <p className="text-xs text-muted-foreground sm:text-sm">
            ...
            {bill.vendor_invoice_number
              ? ` • ${t("vendorInvoiceNumberLabel")} ${bill.vendor_invoice_number}`
              : ""}
          </p>
        </div>
          ...
          <div className="rounded-xl bg-card p-4 ring-1 ring-foreground/10">
            ...
            {isDraft ? (
              <div className="mb-3">
                ...
                <Select
                  value={bill.bank_account_id ?? undefined}
            ...
            {isDraft ? (
              <div className="mb-3 flex items-center justify-between">
                ...
                <Switch
                  checked={bill.round_off_enabled}
