  ...
  if (!purchaseReturn) {
    return (
      <div className="flex flex-col gap-2">
        <Link href={routes.purchases.purchaseReturns.list} className="flex items-center gap-1 text-sm text-muted-foreground hover:text-foreground">
        ...
        <div className="col-span-2 flex flex-col gap-5">
          ...
          {purchaseReturn.reason ? (
            <div className="rounded-xl bg-card p-4 ring-1 ring-foreground/10">
              ...
              <p className="text-sm text-muted-foreground">{purchaseReturn.reason}</p>
            </div>
          ) : null}
        </div>
