...
export const NAV_DATA: NavGroupData[] = [
  {
    labelKey: "dashboard",
    items: [
      { titleKey: "overview", url: routes.dashboard.overview, icon: Gauge },
      { titleKey: "reports", url: routes.dashboard.reports, icon: FileText },
      { titleKey: "analysis", url: routes.dashboard.analysis, icon: LineChart },
    ],
  },
  {
    labelKey: "sales",
  ...
  },
  {
    ...
    items: [
      ...
      { titleKey: "staff", url: routes.catalog.staff, icon: HardHat },
      {
        ...
        url: routes.catalog.staffAttendance,
        icon: CalendarCheck,
      },
      {
        titleKey: "staffVisits",
        url: routes.catalog.staffVisits,
        icon: MapPinned,
      },
      {
        titleKey: "offers",
