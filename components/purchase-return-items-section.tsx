...
export function PurchaseReturnItemsSection({
  ...
  returnLines?.forEach((line) => {
    ...
    returnedByBillLine.set(
      line.purchase_bill_item_id,
      (returnedByBillLine.get(line.purchase_bill_item_id) ?? 0) + line.quantity
    )
  })
  ...
  const availableLines =
    billLines?.filter(
      (line) => (returnedByBillLine.get(line.id) ?? 0) < line.quantity
    ) ?? []
              ...
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead className="text-right">
                    {tBills("quantityLabel")}
                  </TableHead>
                  <TableHead className="text-right">
                    {tBills("unitCostLabel")}
                  </TableHead>
                  <TableHead className="text-right">
                    {tBills("lineTotalLabel")}
                  </TableHead>
